...
class ConanInstallController(object):
    ...
    def install_conan_dependencies(self, host_profile, output_folder, with_tests, clean=False):
        ...
        self.conan.install_dependencies(host_profile, output_folder, with_tests)
